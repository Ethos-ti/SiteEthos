...
// Obter termos da taxonomia 'category' e 'tipo_post'
    ...
    <?php if ( $terms && ! is_wp_error( $terms ) ) : ?>
        <div class="tabs" x-data="{ currentTab: '<?php echo $active_tab?>' }" x-bind="Tabs($data)">
            <div class="tabs__header" role="tablist">
                <a class="tab" x-bind="TabButton('all', $data)" href="<?= esc_url(add_query_arg(array( 'tipo_publicacao' => $tipo_post_slug), get_post_type_archive_link('tipo_publicacao'))); ?>"><?php _e('All the themes', 'hacklabr') ?></a>
                <?php foreach ( $terms as $term ) : ?>
                    <a class="tab" x-bind="TabButton('<?= esc_attr($term->slug); ?>', $data)" href="<?= esc_url(add_query_arg(array('tipo_publicacao' => $tipo_post_slug, 'category' => $term->slug), get_post_type_archive_link('tipo_publicacao'))); ?>">
                        <?= esc_attr($term->name); ?>
                    </a>
                <?php endforeach; ?>
            </div>
